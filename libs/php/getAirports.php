 <?php
    ...
    //$code = strtolower(strval($_REQUEST['code']));
    $code = $_REQUEST['iso'];
    if($code === 'gb') {
        $code = 'uk';
    }

    $url = "https://www.triposo.com/api/20220104/poi.json?tag_labels=poitype-Airport&countrycode=".$code."&fields=name,images,tag_labels,tags,coordinates,snippet&account=GTE06Y8P&token=nyggdwetofqstixix611i3t3j9er2sjc";
