 <?php
    ...
    $url = "https://www.triposo.com/api/20220104/poi.json?tag_labels=beaches&countrycode=".$code."&fields=name,images,coordinates,snippet&account=GTE06Y8P&token=nyggdwetofqstixix611i3t3j9er2sjc";
